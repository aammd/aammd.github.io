...
1. write the model
1. write down some priors
1. condition the model on data
...
First we define the model, here we need to indicate what are parameters by doing a `~1` after each. 
Yes it is a formula with multiple little formulae inside it! Feel the power flow through you.
