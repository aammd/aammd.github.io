...
:::{.callout-note}
Below I describe my attempt to start a whole-blog workflow using `targets`. 
However, this got unwieldly very fast! 
My new plan is to use a targets workflow on a post-by-post basis, using 
:::
