...
All animals respond to the enbironment, adapting thei physical or biological characteristics into 
...
This will come together with the rest of the model soon, but I want to get a start on this now. 
The two traits we are mesauring are kind of weird and different from the tutal way of thinking about environemtnal traits. let me try to explain it. so there was another procedure earlier which attempted to measure the "window" of temperature which provokes the greatest change. 
