...
fit a stan model to it! here is the Stan model:
formatted?
...
This relationship shows the *average* line, the expected size of the tree. 
We can add the original data like this:
